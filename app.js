...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var productOne = multiply(testArray[0], testArray[1])[0];
  var productTwo = multiply(productOne, testArray[2])[0];

  return[ productTwo ,'The numbers ' + testArray + ' have a product of ' + productTwo + '.'];
